...
/*
    ...
    is oriented.
*/
void print_min_path(list_graph_t* lg, int start_node, int end_node) {
    ...
    // Create a parent array and initialize the start node parent to -1
    int parent[lg->nodes];
    parent[start_node] = -1;
